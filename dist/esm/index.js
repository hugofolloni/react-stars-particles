...
var Galaxy = function Galaxy(props) {
  ...
  var _useState3 = useState(props.attract || 0.5),
    _useState4 = _slicedToArray(_useState3, 1),
    ATTRACT_SPEED = _useState4[0];
  var _useState5 = useState(props.repulse || 0.2),
    _useState6 = _slicedToArray(_useState5, 1),
    REPULSE_SPEED = _useState6[0];
  var _useState7 = useState(props.quantity || 400),
    _useState8 = _slicedToArray(_useState7, 1),
    STAR_NUMBER = _useState8[0];
  var _useState9 = useState(props.color || "white"),
